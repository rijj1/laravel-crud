        ...
        <div class="card-body p-4">
            <form action="{{ route("posts.update", $post->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    <div>
                        <img src="{{ asset($post->image) }}" alt="" class="img-thumbnail" width="100">
                    </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" value="{{ $post->title }}" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter post title" style="border-radius: 5px;">
                    @error('title')
                        <div class="text-danger mt-2" style="font-size: 0.875rem;">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        <select name="category_id" class="form-control @error('category_id') is-invalid @enderror" style="border-radius: 5px; padding-left: 10px; appearance: none; background-color: #f4f5f7; border: 1px solid #ced4da;">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="Enter post description" style="border-radius: 5px;">{{ $post->description }}</textarea>
                    @error('description')
                        <div class="text-danger mt-2" style="font-size: 0.875rem;">{{ $message }}</div>
                    @enderror
                </div>
